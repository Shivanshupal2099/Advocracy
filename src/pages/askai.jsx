    ...
    return (
        <>
             ...
             <div style={{height:"80vh",width:"80%", margin: 'auto', position: 'relative'}}>
                <div style={{position: 'absolute', top: 70, left: 110, width: '70%', height: '70%', backgroundImage: `url(${truth})`, backgroundSize: 'contain', backgroundRepeat: 'no-repeat', backgroundPosition: 'center', opacity: 1.2}}></div>
